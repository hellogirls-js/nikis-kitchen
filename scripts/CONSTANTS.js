...
export const ACH_TOOLTIP_TITLE = document.getElementById("achievement-tooltip-title-txt");
export const ACH_TOOLTIP_DESC = document.getElementById("achievement-tooltip-desc");
